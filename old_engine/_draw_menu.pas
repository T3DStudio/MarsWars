...
begin
   ...
   begin
      ...
      _draw_text(tar,ui_menu_map_tx1,_yt(4), theme_name[theme_i]        , ta_middle,255, c_white     );
...
begin
   ...
   ms2_scir : begin
                 ...
                 _draw_text(tar,ui_menu_csm_xt2, y, b2pm[G_shpos or (g_mode in [gm_2fort,gm_3fort,gm_inv,gm_aslt])]   , ta_right ,255 ,c_white);
