...
builder_enrg           : array[0..4] of byte = (8,9,10,11,13);
base_r                 = 350;
base_rr                = base_r*2;
base_3r                = base_r*3;
...
towers_sr              : array[0..3] of integer = (250,270,290,310);
blizz_r                = 175;
mech_adv_rel           : array[false..true] of integer = (vid_fps*10,vid_fps*5);
uac_adv_rel            : array[false..true] of integer = (vid_fps*3,vid_hfps);
g_ct_pr                = 150;
