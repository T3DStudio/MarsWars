...
begin
   ...
   _mkHStrUid(UID_HKeep            ,'Hell Keep'         ,'Builder.'                     );
   _mkHStrUid(UID_HGate            ,'Hell Gate'         ,'Army production.'             );
   _mkHStrUid(UID_HSymbol          ,'Hell Symbol'       ,'Energy production.'           );
   ...
   _mkHStrUid(UID_HMonastery       ,'Hell Monastery'    ,'New technologies.'            );
   _mkHStrUid(UID_HTotem           ,'Hell Totem'        ,'Advanced defensive structure.');
   _mkHStrUid(UID_HAltar           ,'Hell Altar'        ,'Invulnerability caster.'      );
   _mkHStrUid(UID_HFortress        ,'Hell Fortress'     ,'');
   _mkHStrUid(UID_HMilitaryUnit    ,'Hell Military Base','Corrupted UAC Military Base.' );
   ...
   _mkHStrUpid(r_hell,upgr_attack  ,'Range attack upgrade'           ,'Increase all ranged attacks damage.'                                       );
   ...
   _mkHStrUpid(r_hell,upgr_towers  ,'Towers range upgrade'           ,'Increased range of defensive structures.'                                  );
   ...
   _mkHStrUpid(r_hell,upgr_6bld    ,'Hell power'                     ,'Allow Hell Monastery to advance units.'                                    );
   _mkHStrUpid(r_hell,upgr_boost   ,'Ancient evil'                   ,'"Boost" ability for Hell Monastery.'                                        );
   ...
   _mkHStrUid(UID_UCommandCenter  ,'UAC Command Center'         ,'Builder.'                        );
   _mkHStrUid(UID_UMilitaryUnit   ,'UAC Military Base'          ,'Army production.'                );
   _mkHStrUid(UID_UGenerator      ,'UAC Generator'              ,'Energy production.'              );
   ...
   _mkHStrUid(UID_UPTurret        ,'UAC Plasmagun Turret'       ,'Defensive structure.'            );
   _mkHStrUid(UID_URocketL        ,'UAC Missile Strike Station' ,''          );
   _mkHStrUid(UID_URTurret        ,'UAC Rocket Launcher Turret' ,'Defensive structure.'            );
   ...
   _mkHStrUpid(r_uac ,upgr_attack  ,'Ranged attack upgrade'  ,'Increase damage of all ranged attacks.'                             );
   ...
   _mkHStrUpid(r_uac ,upgr_boost   ,'High technologies'      ,'"Boost" ability for Tech Center.'             );
   ...
   _mkHStrUpid(r_uac ,upgr_mainonr ,'Free placement'         ,'Command Сenter will be able to land on obstacles.');
   _mkHStrUpid(r_uac ,upgr_turarm  ,'Turrets armor'          ,'Additional armor for turrets.'                    );
   _mkHStrUpid(r_uac ,upgr_rturrets,'Rocket turrets'         ,'Allows you to build Rocket turrets.'              );
   ...
   _mkHStrXY(3,10,0,0,str_maction+' ('     +#18+'Alt'   +#25+'+'+#18+'X'+#25+')');
   _mkHStrXY(3,11,0,0,'Cancel production ('+#18+'C'     +#25+')');

   _mkHStrXY(3,12,0,0,'Fog of war ('           +#18+'Q'+#25+')');
   _mkHStrXY(3,15,0,0,'Faster game speed ('    +#18+'A'+#25+')');
   _mkHStrXY(3,16,0,0,'Left click: skip 2 seconds ('+#18+'S'+#25+')'+#11+
                      'Right click: skip 10 seconds ('+#18+'Ctrl'+#25+'+'+#18+'S'+#25+')'+#11+
                      'Skip 1 minute ('+#18+'Alt'+#25+'+'+#18+'S'+#25+')' );
   _mkHStrXY(3,17,0,0,'Pause ('                +#18+'D'+#25+')');
   _mkHStrXY(3,18,0,0,'Player POV ('           +#18+'Z'+#25+')');
   _mkHStrXY(3,19,0,0,'List of game messages ('+#18+'X'+#25+')');
...
begin
  ...
  _mkHStrUpid(r_hell,upgr_boost   ,'Древнее зло'                    ,'Второй уровень зданий, юнитов и улучшений.'                              );
  ...
  _mkHStrUpid(r_uac ,upgr_boost   ,'Выские технологии'        ,'Второй уровень зданий, юнитов и улучшений.'               );
  ...
  _mkHStrUpid(r_uac ,upgr_rturrets,'Ракетные турели'          ,'Позволяет строить ракетные турели.'                       );
  ...
  _mkHStrXY(3,12,0,0,'Туман войны ('             +#18+'Q'+#25+')');
  _mkHStrXY(3,15,0,0,'Включить/выключить ускоренный просмотр ('+#18+'A'+#25+')');
  _mkHStrXY(3,16,0,0,'Левый клик: пропустить 2 секунды (' +#18+'S'+#25+')'+#11+
                     'Правый клик: пропустить 10 секунд ('+#18+'Ctrl'+#25+'+'+#18+'S'+#25+')'+#11+
                     'Пропустить 1 минуту ('              +#18+'Alt'+#25+'+'+#18+'S'+#25+')' );
  _mkHStrXY(3,17,0,0,'Пауза ('                   +#18+'D'+#25+')');
  _mkHStrXY(3,18,0,0,'Камера игрока ('           +#18+'Z'+#25+')');
  _mkHStrXY(3,19,0,0,'Список игровых сообщений ('+#18+'X'+#25+')');
