...
gm_royl:
      begin
         circleColor(_screen,map_cx-vid_vx,map_cx-vid_vy,g_royal_r,ui_rad_rld[(g_royal_r mod 2)>0]);
         if(vid_rtui=0)then circleColor(_minimap,vid_mmcx,vid_mmcx,trunc(g_royal_r*map_mmcx)+1,ui_rad_rld[(g_royal_r mod 2)>0]);
      end;
   end;
    ...
    with _units[u] do
     ...
     begin
        ...
        begin
           ...
           circleColor(_screen,ix,iy,ar,c_lime);
           circleColor(_screen,ix,iy,arf,c_blue);
