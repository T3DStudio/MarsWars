...
cfg_key_MusicListRenew  = 'music_renew';
...
cfg_key_UIShowPScreens  = 'ui_show_PlayersScreens';
...
cfg_key_MusicListRenew  : snd_RenewMusicList :=(vl=b2c[true]);
...
cfg_key_UIShowPScreens  : ui_PlayersScreens  :=(vl=b2c[true]);
