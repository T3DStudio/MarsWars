...
cfg_key_g_StartBase    = 'g_start_base';
...
cfg_key_MouseScroll   : vid_CamMScroll   :=(vl=str_b2c[true]);
...
cfg_key_g_StartBase   : g_start_base     := vlw;
...
begin
   ...
   begin
      ...
      PlayerName:=ValidateStr(PlayerName,PlayerNameLen,@k_pname);
...
{$I-}rewrite(f);{$I+} if (ioresult<>0) then exit;
   ...
   writeln(f,cfg_key_MouseScroll   ,'=',str_b2c[vid_CamMScroll]   );
   ...
   writeln(f,cfg_key_g_StartBase   ,'=',g_start_base              );
