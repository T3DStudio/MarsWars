...
begin
   ...
   begin
      uid_snd_ready :=ready;
      uid_snd_move  :=move;
      uid_snd_attack:=attack;
      uid_snd_annoy :=annoy;
      uid_snd_select:=select;
   end;
end;
...
begin
   ...
   with uid_arms[aa] do
   begin
      uid_eid_Summon[aa]:=summon;
      uid_eid_Death [aa]:=death;
      uid_eid_DeathFast[aa]:=fdeath;
      uid_eid_pain  [aa]:=pain;
   end;
end;
...
begin
   with g_uids[u] do
   begin
      uid_eid_snd_summon:=summon;
      uid_eid_snd_death :=death;
      uid_eid_snd_fdeath:=fdeath;
      uid_eid_snd_pain  :=pain;
   end;
   un_eid_snd_set:=true;
end;
...
begin
   ...
   setBuildingSND(snd_uac_rescc);
      ...
      if(uid_class<=ui_ButtonsNum)then
        if  (ui_panel_uids[uid_race,byte(not uid_ukbuilding),uid_class] =0)
        then ui_panel_uids[uid_race,byte(not uid_ukbuilding),uid_class]:=u;
   ...
   begin
      ...
      case u of
upgr_hell_DistDamage1   : begin upgr_btn:=spr_b_Upgrades[r_hell,0 ]; end;
upgr_hell_UnitArmor     : begin upgr_btn:=spr_b_Upgrades[r_hell,1 ]; end;
upgr_hell_BuildArmor    : begin upgr_btn:=spr_b_Upgrades[r_hell,2 ]; end;
upgr_hell_MeleeDamage   : begin upgr_btn:=spr_b_Upgrades[r_hell,3 ]; end;
upgr_hell_Regeneration  : begin upgr_btn:=spr_b_Upgrades[r_hell,4 ]; end;
upgr_hell_PainFactor    : begin upgr_btn:=spr_b_Upgrades[r_hell,5 ]; end;
upgr_hell_BuilderR      : begin upgr_btn:=spr_b_Upgrades[r_hell,11]; end;
upgr_hell_HKTeleport    : begin upgr_btn:=spr_b_Upgrades[r_hell,9 ]; end;
upgr_hell_DecayAura     : begin upgr_btn:=spr_b_Upgrades[r_hell,10]; end;
upgr_hell_TowerR        : begin upgr_btn:=spr_b_Upgrades[r_hell,7 ]; end;
upgr_hell_Spectre       : begin upgr_btn:=spr_b_Upgrades[r_hell,19]; end;
upgr_hell_UnitSightR    : begin upgr_btn:=spr_b_Upgrades[r_hell,13]; end;
upgr_hell_Phantoms      : begin upgr_btn:=spr_b_Upgrades[r_hell,15]; end;
upgr_hell_DistDamage2   : begin upgr_btn:=spr_b_Upgrades[r_hell,20]; end;
upgr_hell_Resurrect     : begin upgr_btn:=spr_b_Upgrades[r_hell,12]; end;
upgr_hell_TeleportCD    : begin upgr_btn:=spr_b_Upgrades[r_hell,8 ]; end;
upgr_hell_Recall        : begin upgr_btn:=spr_b_Upgrades[r_hell,14]; end;
upgr_hell_EvilEyeR      : begin upgr_btn:=spr_b_Upgrades[r_hell,6 ]; end;
upgr_hell_TotemInvis    : begin upgr_btn:=spr_b_Upgrades[r_hell,16]; end;
upgr_hell_BuildRestore  : begin upgr_btn:=spr_b_Upgrades[r_hell,17]; end;
upgr_hell_TowerBlink    : begin upgr_btn:=spr_b_Upgrades[r_hell,18]; end;

upgr_uac_DistDamage     : begin upgr_btn:=spr_b_Upgrades[r_uac ,0 ]; end;
upgr_uac_BioArmor       : begin upgr_btn:=spr_b_Upgrades[r_uac ,1 ]; end;
upgr_uac_BuildArmor     : begin upgr_btn:=spr_b_Upgrades[r_uac ,2 ]; end;
upgr_uac_RepairTools    : begin upgr_btn:=spr_b_Upgrades[r_uac ,3 ]; end;
upgr_uac_BioSpeed       : begin upgr_btn:=spr_b_Upgrades[r_uac ,4 ]; end;
upgr_uac_ssgup          : begin upgr_btn:=spr_b_Upgrades[r_uac ,14]; end;
upgr_uac_BuilderR       : begin upgr_btn:=spr_b_Upgrades[r_uac ,11]; end;
upgr_uac_CCFly          : begin upgr_btn:=spr_b_Upgrades[r_uac ,9 ]; end;
upgr_uac_CCAttack       : begin upgr_btn:=spr_b_Upgrades[r_uac ,10]; end;
upgr_uac_TowerR         : begin upgr_btn:=spr_b_Upgrades[r_uac ,7 ]; end;
upgr_uac_DronTurret     : begin upgr_btn:=spr_b_Upgrades[r_uac ,20]; end;
upgr_uac_UnitSightR     : begin upgr_btn:=spr_b_Upgrades[r_uac ,12]; end;
upgr_uac_CommandoInvis  : begin upgr_btn:=spr_b_Upgrades[r_uac ,19]; end;
upgr_uac_AASplash       : begin upgr_btn:=spr_b_Upgrades[r_uac ,13]; end;
upgr_uac_MechSpeed      : begin upgr_btn:=spr_b_Upgrades[r_uac ,15]; end;
upgr_uac_MechArmor      : begin upgr_btn:=spr_b_Upgrades[r_uac ,16]; end;
upgr_uac_TerAAWeapon    : begin upgr_btn:=spr_b_Upgrades[r_uac ,17]; end;
upgr_uac_Transport      : begin upgr_btn:=spr_b_Upgrades[r_uac ,6 ]; end;
upgr_uac_RadarR         : begin upgr_btn:=spr_b_Upgrades[r_uac ,8 ]; end;
upgr_uac_TurretPlasma   : begin upgr_btn:=spr_b_Upgrades[r_uac ,5 ]; end;
upgr_uac_TurretArmor    : begin upgr_btn:=spr_b_Upgrades[r_uac ,18]; end;
