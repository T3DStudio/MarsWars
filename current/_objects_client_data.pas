...
begin
   ...
   begin
      ...
      case u of
upgr_hell_t1attack  : begin _up_btn:=spr_b_Upgrades[r_hell,0 ]; end;
upgr_hell_uarmor    : begin _up_btn:=spr_b_Upgrades[r_hell,1 ]; end;
upgr_hell_barmor    : begin _up_btn:=spr_b_Upgrades[r_hell,2 ]; end;
upgr_hell_mattack   : begin _up_btn:=spr_b_Upgrades[r_hell,3 ]; end;
upgr_hell_vision    : begin _up_btn:=spr_b_Upgrades[r_hell,13]; end;
upgr_hell_regen     : begin _up_btn:=spr_b_Upgrades[r_hell,4 ]; end;
upgr_hell_pains     : begin _up_btn:=spr_b_Upgrades[r_hell,5 ]; end;
upgr_hell_heye      : begin _up_btn:=spr_b_Upgrades[r_hell,6 ]; end;
upgr_hell_towers    : begin _up_btn:=spr_b_Upgrades[r_hell,7 ]; end;
upgr_hell_teleport  : begin _up_btn:=spr_b_Upgrades[r_hell,8 ]; end;
upgr_hell_HKTeleport: begin _up_btn:=spr_b_Upgrades[r_hell,9 ]; end;
upgr_hell_paina     : begin _up_btn:=spr_b_Upgrades[r_hell,10]; end;
upgr_hell_buildr    : begin _up_btn:=spr_b_Upgrades[r_hell,11]; end;
upgr_hell_spectre   : begin _up_btn:=spr_b_Upgrades[r_hell,19]; end;
upgr_hell_phantoms  : begin _up_btn:=spr_b_Upgrades[r_hell,15]; end;
upgr_hell_t2attack  : begin _up_btn:=spr_b_Upgrades[r_hell,20]; end;
upgr_hell_rteleport : begin _up_btn:=spr_b_Upgrades[r_hell,14]; end;
upgr_hell_totminv   : begin _up_btn:=spr_b_Upgrades[r_hell,16]; end;
upgr_hell_bldrep    : begin _up_btn:=spr_b_Upgrades[r_hell,17]; end;
upgr_hell_tblink    : begin _up_btn:=spr_b_Upgrades[r_hell,18]; end;
upgr_hell_resurrect : begin _up_btn:=spr_b_Upgrades[r_hell,12]; end;

upgr_uac_attack     : begin _up_btn:=spr_b_Upgrades[r_uac ,0 ]; end;
upgr_uac_uarmor     : begin _up_btn:=spr_b_Upgrades[r_uac ,1 ]; end;
upgr_uac_barmor     : begin _up_btn:=spr_b_Upgrades[r_uac ,2 ]; end;
upgr_uac_tools      : begin _up_btn:=spr_b_Upgrades[r_uac ,3 ]; end;
upgr_uac_vision     : begin _up_btn:=spr_b_Upgrades[r_uac ,12]; end;
upgr_uac_mspeed     : begin _up_btn:=spr_b_Upgrades[r_uac ,4 ]; end;
upgr_uac_plasmt     : begin _up_btn:=spr_b_Upgrades[r_uac ,5 ]; end;
upgr_uac_towers     : begin _up_btn:=spr_b_Upgrades[r_uac ,7 ]; end;
upgr_uac_radar_r    : begin _up_btn:=spr_b_Upgrades[r_uac ,8 ]; end;
upgr_uac_CCFly      : begin _up_btn:=spr_b_Upgrades[r_uac ,9 ]; end;
upgr_uac_ccturr     : begin _up_btn:=spr_b_Upgrades[r_uac ,10]; end;
upgr_uac_buildr     : begin _up_btn:=spr_b_Upgrades[r_uac ,11]; end;
upgr_uac_commando   : begin _up_btn:=spr_b_Upgrades[r_uac ,19]; end;
upgr_uac_botturret  : begin _up_btn:=spr_b_Upgrades[r_uac ,20]; end;
upgr_uac_airsp      : begin _up_btn:=spr_b_Upgrades[r_uac ,13]; end;
upgr_uac_ssgup      : begin _up_btn:=spr_b_Upgrades[r_uac ,14]; end;
upgr_uac_transport  : begin _up_btn:=spr_b_Upgrades[r_uac ,6 ]; end;
upgr_uac_mechspd    : begin _up_btn:=spr_b_Upgrades[r_uac ,15]; end;
upgr_uac_mecharm    : begin _up_btn:=spr_b_Upgrades[r_uac ,16]; end;
upgr_uac_turarm     : begin _up_btn:=spr_b_Upgrades[r_uac ,18]; end;
upgr_uac_antiair    : begin _up_btn:=spr_b_Upgrades[r_uac ,17]; end;
