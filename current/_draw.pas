...
begin
   ...
   if(not _players[HPlayer].observer)and(not GameCheckEndStatus)and(rpls_state<rpls_read)
...
begin
   ...
   ' '+b2c[MapPointInScreenP(mouse_map_x,mouse_map_y,true)]+
   //' '+b2c[fog_check(mouse_map_x-vid_cam_x,mouse_map_y-vid_cam_y,@i,@n)]+
   ' '+i2s(i)+' '+i2s(n)
