...
begin
   ...
   setEffectEID (0  ,EID_Exp,EID_Exp,0  );
...
begin
   ...
   setEffectEID(EID_HCC ,EID_BBExp           ,EID_BBExp           ,0  );
...
begin
   ...
   setEffectEID (0  ,EID_BExp,EID_BExp,0  );
   setEffectSND (nil,snd_exp ,snd_exp ,nil);
end;
UID_APC:
begin
   ...
   un_eid_bcrater:=255;
      ...
      begin
       ...
       r_uac : begin
         ...
         if(_r>42)then
         begin
            setEffectEID(0  ,EID_BBExp           ,EID_BBExp           ,0  );
