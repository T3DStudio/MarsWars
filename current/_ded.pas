...
begin
   ...
   begin
      ...
      16: Dedicated_screenLine(str_map_ScenarioL[map_scenario],1, str_map_GeneratorsL[map_generators],15, c2s(map_seed),30, i2s(map_Size1),45, strMX(map_ObstaclesF),55, b2c[map_symmetry],70);
      18: writeln;
