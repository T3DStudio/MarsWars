...
begin
   ...
   begin
      ...
      _draw_text(tar,ui_menu_map_tx0,_yt(2), str_m_obs+_str_mx(map_obs) , ta_left  ,255, mic(c,false));
      _draw_text(tar,ui_menu_map_tx0,_yt(3), str_m_sym+b2cc[map_symmetry],ta_left  ,255, mic(c,false));
