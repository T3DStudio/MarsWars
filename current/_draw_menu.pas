...
begin
   ...
   begin
      ...
      _draw_text(tar,ui_menu_map_tx0,_yt(2), str_m_tpe+str_mapt[map_type], ta_left  ,255, mic(c,false));
      _draw_text(tar,ui_menu_map_tx0,_yt(3), str_m_sym+str_m_symt[map_symmetry], ta_left  ,255, mic(c,false));
...
begin
   ...
   begin
     ...
     begin
        _draw_text(tar,ui_menu_pls_xc, 96, str_MServers+'('+i2s(net_svsearch_listn)+')', ta_middle,255, c_white);
        _draw_text(tar,ui_menu_pls_xc, ui_menu_pls_ye+5, str_connect[false], ta_middle,255, mic((0<=net_svsearch_sel)and(net_svsearch_sel<net_svsearch_listn),false));

        hlineColor(tar,ui_menu_pls_x0,ui_menu_pls_x1,ui_menu_pls_y0,c_white);
        hlineColor(tar,ui_menu_pls_x0,ui_menu_pls_x1,ui_menu_pls_ye,c_white);
        ...
        if(net_svsearch_listn>0)then
         ...
         begin
            ...
            if(p<net_svsearch_listn)then
              ...
              begin
                 y:=ui_menu_pls_y0+u*ui_menu_pls_ys3;
                 if(p=net_svsearch_sel)then boxColor(tar,ui_menu_pls_x0,y+1,ui_menu_pls_x1,y+ui_menu_pls_ys3,c_dgray);
                 hlineColor(tar,ui_menu_pls_x0,ui_menu_pls_x1,y+ui_menu_pls_ys3,c_white);
                 _draw_text(tar,ui_menu_pls_x0,ui_menu_pls_y2+u*ui_menu_pls_ys3,i2s(p+1)+')'+info,ta_left,ui_menu_chat_width,c_white);
              end;
         end;
     end
     else
...
begin
   ...
   _draw_text(tar,t+ui_menu_ssr_xs  , y, str_menu_s1[ms1_svld], ta_middle, 255,mic((net_status=ns_single)and(ServerSide),menu_s1=ms1_svld));
   _draw_text(tar,t+ui_menu_ssr_xs*2, y, str_menu_s1[ms1_reps], ta_middle, 255,mic(net_status=ns_single,menu_s1=ms1_reps));
   ...
   ms1_sett : begin
                 ...
                 begin
                    ...
                    y:=_yt(7);
                    _draw_text(tar,i,y, str_plname, ta_left,255, mic((net_status=ns_single)and(G_Started=false),menu_item=11));
                    _draw_text(tar,ui_menu_ssr_x2+6,y, PlayerName, ta_left  ,255, mic((net_status=ns_single)and(G_Started=false),menu_item=11));
                    vlineColor(tar,ui_menu_ssr_x2,y-6,y+12,c_gray);
   ...
   ms1_svld : begin
                 ...
                 begin
                    ...
                    begin
                       ...
                       begin
                          boxColor(tar,ui_menu_ssr_x0,y+1,ui_menu_ssl_x0-1,y+ui_menu_ssr_ys-1,c_dgray);
...
begin
   ...
   _draw_text(tar,t                 , y, str_menu_s2[ms2_camp], ta_middle, 255,mic(false and (net_status=ns_single)and(G_Started=false),menu_s2=ms2_camp));
   ...
   ms2_mult : begin
                 _draw_text(tar,ui_menu_csm_xc, _yt(12), str_menu_chat, ta_middle,255, mic((net_status<>ns_single)and(not net_svsearch),m_chat));
                 ...
                 begin
                    ...
                    y:=_yt(3);
                    _draw_text(tar,ui_menu_csm_xt0, y,str_udpport                          , ta_left  ,255 ,mic((net_status=ns_single),menu_item=87));
                    _draw_text(tar,ui_menu_csm_xt2, y,net_sv_pstr                          , ta_right ,255 ,mic((net_status=ns_single),menu_item=87));
                    ...
                    y:=_yt(7);
                    _draw_text(tar,ui_menu_csm_xt0, y, str_netsearch                       , ta_left  ,255, mic((G_Started=false)and(net_svsearch or (net_status=ns_single)),net_svsearch));

                    y:=_yt(8);
                    vlineColor(tar,ui_menu_csm_x3 , _yl(8),_yl(8)+ui_menu_csm_ys, c_gray);
                    _draw_text(tar,ui_menu_csm_xt2, y, str_connect[net_status=ns_client]   , ta_right ,255, mic((net_status<>ns_server)and(not net_svsearch)and((net_status=ns_client)or(G_Started=false)),false));
                    _draw_text(tar,ui_menu_csm_xt0, y, net_cl_svstr                        , ta_left  ,255, mic((net_status=ns_single),menu_item=92));
